...
public final class JavaRecvCount {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (args.length < 1) {
      System.err.println("Usage: JavaRecvCount <file>");
      System.exit(1);
    }

    // Create a new Spark Context
    SparkConf conf = new SparkConf().setAppName("RecvCount");
    ...
    System.setOut(new PrintStream(new FileOutputStream("recvcounts")));
